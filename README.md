...
<b><sup>†</sup></b> These models were published by [Ma et al.](https://github.com/mpc001/Visual_Speech_Recognition_for_Multiple_Languages). However, the structere of the indicated checkpoints have been modified so that they can be loaded using the scripts provided in this repository.
